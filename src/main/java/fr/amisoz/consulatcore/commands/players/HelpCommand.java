...
public class HelpCommand extends ConsulatCommand {
    ...
    private String helpMessage = "§7§l§m-------§r§7§l[ §r§6ConsulatHelp §r§7§l]§m-------\n" +
            ...
            "§r§6Le shop est situé au spawn, il te permet de vendre différents item à différents prix afin d'obtenir de la monnaie pour les tp, les claims, etc.";
