package fr.leconsulat.core.guis.city.members.member.claims.permissions;
...
public class AccessPermissionsGui extends DataRelatGui<Claim> {
    ...
    public AccessPermissionsGui(DataRelatGui<UUID> link, Claim claim){
        ...
        setLink(link);
        ((fr.leconsulat.core.guis.claims.permissions.AccessPermissionsGui)link).setLink(this);
    }
