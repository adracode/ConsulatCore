package fr.leconsulat.core.guis.city.members.member.claims;
...
import fr.leconsulat.core.guis.city.members.member.claims.permissions.AccessPermissionsGui;
    ...
    public Relationnable createChild(@Nullable Object key){
        if(key instanceof Claim){
            ...
            return new AccessPermissionsGui(
                    (fr.leconsulat.core.guis.claims.permissions.AccessPermissionsGui)
